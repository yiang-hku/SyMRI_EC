...
- High risk definition: https://www.medilib.ir/uptodate/show/16721
...
list_high = which(df$Histology == 2 | df$Histology == 3 | (df$Grade == 3 & df$MI == 2 & df$Histology == 1) | df$stage == '3a' | df$stage == '3b' | df$stage == '3c1' | df$stage == '3c2' | df$stage == '4' | df$stage == '3'); 
