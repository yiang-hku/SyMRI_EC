...
MedianCI(df_gra2$T1, conf.level = 0.95, na.rm = TRUE)
MedianCI(df_gra2$T2, conf.level = 0.95, na.rm = TRUE)
MedianCI(df_gra2$PD, conf.level = 0.95, na.rm = TRUE)
MedianCI(df_gra2$ADC, conf.level = 0.95, na.rm = TRUE)

MedianCI(df_gra3$T1, conf.level = 0.95, na.rm = TRUE)
MedianCI(df_gra3$T2, conf.level = 0.95, na.rm = TRUE)
MedianCI(df_gra3$PD, conf.level = 0.95, na.rm = TRUE)
MedianCI(df_gra3$ADC, conf.level = 0.95, na.rm = TRUE)
